...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    ?>
    <div class="box">
    <form action="prosesbukuadm.php" class="form-horizontal" method="post">
    	<h4>Silahkan Edit Data Buku</h4>
      <div class="form-group has-feedback">
        <input type="hidden" name="id" value="<?php echo $d['id_buku']; ?>">
        <label for="kode" class="col-sm-2 control-label">Kode</label>
        <div class="col-sm-9" style="width: 930px;">
        <input type="text" class="form-control" placeholder="Kode Buku" name="kode" value="<?php echo $d['kode_buku']; ?>">
    </div>
      </div>
      <div class="form-group has-feedback">
      	<label for="judul" class="col-sm-2 control-label">Judul</label>
      	<div class="col-sm-9" style="width: 930px;">
        <input type="text" class="form-control" placeholder="Judul Buku" name="judul" value="<?php echo $d['judul_buku']; ?>">
    </div>
      </div>
      <div class="form-group has-feedback">
        ...
        <select name="jenis" class="form-control">
        	<option <?php echo ($jenis =='Novel')?"selected":""?>>Novel</option>
        	<option <?php echo ($jenis =='Pelajaran')?"selected":""?>>Pelajaran</option>
        	<option <?php echo ($jenis =='Komik')?"selected":""?>>Komik</option>
        </select>
    </div>
      </div>
      <div class="form-group has-feedback">
      	...
      	<div class="col-sm-9" style="width: 930px;">
        <input type="text" class="form-control" placeholder="Pengarang" name="pengarang" value="<?php echo $d['pengarang']; ?>">
    </div>
      </div>
      <div class="form-group has-feedback">
      	<label for="penerbit" class="col-sm-2 control-label">Penerbit</label>
      	<div class="col-sm-9" style="width: 930px;">
        <input type="text" class="form-control" placeholder="Penerbit" name="penerbit" value="<?php echo $d['penerbit']; ?>">
    </div>
      </div>
      <div class="form-group has-feedback">
      	<label for="tahun" class="col-sm-2 control-label">Tahun</label>
        <div class="col-sm-9" style="width: 930px;">
        <input type="text" class="form-control" placeholder="Tahun" name="tahun" value="<?php echo $d['tahun']; ?>">
    </div>
      </div>
      <div class="form-group has-feedback">
      	<div class="col-sm-12 pull-right">
      <button type="submit" class="btn btn-success" name="edit">Update Data</button>
      <a href="index.php" class="pull-left btn btn-primary" style="margin-left: 7px;">Batal</a>
  </div>
  </div></br>
    </form>
    <?php } ?>
