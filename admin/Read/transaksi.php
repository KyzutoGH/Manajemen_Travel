                            ...
                            ");
                                ...
                                while ($d = mysqli_fetch_array($data)) {
                                    ...
                                    <tr>
                                        <td><?php echo $no++; ?></td>
                                        <td><a
                                                href="index.php?submenu=Detail&idtrx=<?php echo $d['ID Transaksi'] ?>"><?php echo $d['Nama Pelanggan']; ?></a>
                                        </td>
                                        <td><a href="index.php?submenu=Jadwal&idjadwal=<?php echo $d['IDJadwal']; ?>"
                                                title="<?php echo $d['NamaArmada'] . ' - ' . $d['Asal'] . ' - ' . $d['Tujuan']; ?>"><?php echo $d['Perjalanan']; ?></a>
                                        </td>
                                        <td>
                                            <?php
                                        ...
                                        <td>
                                            <button class="btn btn-primary" data-toggle="modal"
                                                data-target="#imageModal__<?php echo $d['IDTransaksi']; ?>">Tampilkan
                                                Bukti</button>
                                        </td>

                                        <!-- Modal for each row Lihat Bukti -->
                                        <div class="modal fade" id="imageModal__<?php echo $d['IDTransaksi']; ?>"
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <img id="modalImage"
                                                            src="../dist/img/trxs/<?php echo $d['BuktiTransaksi']; ?>"
                                                            alt="Tidak Ada Bukti" style="max-width: 100%; height: auto;">
                                        ...
                                        <td>
                                            <span
                                                class="<?php echo ($d['Status'] == 'Belum Dibayar') ? 'label label-danger' : (($d['Status'] == 'Dibayar') ? 'label label-warning' : (($d['Status'] == 'Dibatalkan') ? 'label label-success' : '')); ?>">
                                        ...
                                        <td>
                                            ...
                                            <?php } elseif ($d['Status'] === 'Belum Kirim Bukti') { ?>
                                                <a
                                                    href="Update/transaksi/batal.php?idtrx=<?php echo $d['ID Transaksi']; ?>&status=<?php echo $d['Status']; ?>">
                                                    <span class="label label-danger">Batalkan Pesanan</span>
                                                </a>

                                            <?php } else { ?>
                                                <a class="col-xs-offset-1"
                                                    href="Update/transaksi/bayar.php?idtrx=<?php echo $d['ID Transaksi']; ?>">
                                                    <span class="label label-success">Konfirmasi</span>
                                                </a>
                                                <a class="col-xs-offset-1"
                                                    href="Update/transaksi/batal.php?idtrx=<?php echo $d['ID Transaksi']; ?>">
