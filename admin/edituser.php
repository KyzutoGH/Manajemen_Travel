  ...
  <section class="content-header">
    ...
    <form action="editproses.php" class="form-horizontal" method="post">
      ...
      <div class="form-group has-feedback">
        ...
        <input type="text" class="form-control" placeholder="Username Baru" name="kode" value="<?php echo $d['username']; ?>">
    </div>
    <div class="form-group has-feedback">
        <label for="pass" class="col-sm-2 control-label">Password</label>
        <div class="col-sm-9" style="width: 930px;">
        <input type="password" class="form-control" placeholder="Password Baru" name="pass" value="<?php echo $d['password']; ?>">
    </div>
      </div>
      <div class="form-group has-feedback">
    ...
    <div class="form-group has-feedback">
      ...
      <a href="editmember.php" class="pull-left btn btn-primary" style="margin-left: 50px;">Batal</a>
  </div>
  </div><br><br>
    </form>
    <?php 
