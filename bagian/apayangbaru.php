                ...
                <div class="box">
                    <div class="box-body">
                        <ul>
                            ...
                            <ul>
                                <li>Batas Waktu Bayar dan Kirim Bukti</li>
                                <li>Sisa Tempat Duduk</li>
                                <li>Fitur Ulasan Pelanggan</li>
                                <li>Perbaikan Beberapa Bug Yang Belum Terdeteksi</li>
                            </ul>
                            <li>
